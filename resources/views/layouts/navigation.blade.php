        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center text-sm font-medium text-white hover:text-orange-400 hover:border-gray-300 focus:outline-none focus:text-orange-400 focus:border-gray-300 transition duration-150 ease-in-out">
